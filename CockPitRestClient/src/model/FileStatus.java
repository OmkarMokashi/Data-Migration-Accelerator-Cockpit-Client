...
public class FileStatus {
	...
	public FileStatus(String name, String enlisted, String extracted, String inCleaning, String cleaned,
	...
	public String toJsonString(List<FileStatus> bulkFileStatus) throws Exception {
		ObjectMapper mapper = new ObjectMapper();
		String jsonInString = mapper.writeValueAsString(bulkFileStatus);
		return jsonInString;
	}
